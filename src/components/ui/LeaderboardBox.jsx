    ...
    <div className="voz-card overflow-hidden">
      ...
      <div className="bg-[var(--voz-accent)] border-b border-[var(--voz-border)] flex text-[13px]">
        <button 
          ...
          className={`flex-1 px-3 py-2 font-medium transition-colors ${tab === 'total' ? 'text-[var(--voz-link)] border-b-2 border-[var(--voz-link)]' : 'text-[var(--voz-text-muted)] hover:text-[var(--voz-text)]'}`}
        >
          <Trophy size={14} className="inline mr-1" /> Tổng
        </button>
        <button 
          onClick={() => setTab('month')}
          className={`flex-1 px-3 py-2 font-medium transition-colors ${tab === 'month' ? 'text-[var(--voz-link)] border-b-2 border-[var(--voz-link)]' : 'text-[var(--voz-text-muted)] hover:text-[var(--voz-text)]'}`}
        >
